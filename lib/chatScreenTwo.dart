...
class ChatScreenTwo extends StatefulWidget {
  String user;
  String sm, image, messagess;

  ChatScreenTwo({this.user, this.sm, this.image,this.messagess});

  @override
  _ChatScreenState createState() => _ChatScreenState(sm,image,messagess);
}

class _ChatScreenState extends State<ChatScreenTwo> {
  String sm,image,messagess;

  _ChatScreenState(this.sm, this.image, this.messagess);
